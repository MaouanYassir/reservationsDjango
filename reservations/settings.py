...
SECRET_KEY = 'django-insecure-u1xb-ll==pr#*_#(meo@!qn)jv1h!3fv^%=$czg8&h2_z2$_nb'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'reservations/catalogue/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# URL de connexion et de redirection après connexion
